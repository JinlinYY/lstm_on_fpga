...
// ==============================================================
#ifndef __LSTM_Top_drecip_6chv__HH__
#define __LSTM_Top_drecip_6chv__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_drecip_6chv) {
    ...
    SC_CTOR(LSTM_Top_drecip_6chv):  ACMP_drecip_U ("ACMP_drecip_U") {
