...
// ==============================================================
#ifndef __LSTM_Top_mul_72nshbi__HH__
#define __LSTM_Top_mul_72nshbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_mul_72nshbi) {
    ...
    SC_CTOR(LSTM_Top_mul_72nshbi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
