...
// ==============================================================
#ifndef __LSTM_Top_fexp_32ncgu__HH__
#define __LSTM_Top_fexp_32ncgu__HH__
#include "ACMP_fexp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_fexp_32ncgu) {
    ...
    SC_CTOR(LSTM_Top_fexp_32ncgu):  ACMP_fexp_U ("ACMP_fexp_U") {
        ACMP_fexp_U.clk(clk);
