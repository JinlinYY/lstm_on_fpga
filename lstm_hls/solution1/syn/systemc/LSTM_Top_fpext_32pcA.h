...
// ==============================================================
#ifndef __LSTM_Top_fpext_32pcA__HH__
#define __LSTM_Top_fpext_32pcA__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_fpext_32pcA) {
    ...
    SC_CTOR(LSTM_Top_fpext_32pcA):  ACMP_fpext_comb_U ("ACMP_fpext_comb_U") {
