...
// ==============================================================
#ifndef __LSTM_Top_dadd_64nrcU__HH__
#define __LSTM_Top_dadd_64nrcU__HH__
#include "ACMP_dadd.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_dadd_64nrcU) {
    ...
    SC_CTOR(LSTM_Top_dadd_64nrcU):  ACMP_dadd_U ("ACMP_dadd_U") {
        ACMP_dadd_U.clk(clk);
