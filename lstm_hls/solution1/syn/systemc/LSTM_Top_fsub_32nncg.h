...
// ==============================================================
#ifndef __LSTM_Top_fsub_32nncg__HH__
#define __LSTM_Top_fsub_32nncg__HH__
#include "ACMP_fsub.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_fsub_32nncg) {
    ...
    SC_CTOR(LSTM_Top_fsub_32nncg):  ACMP_fsub_U ("ACMP_fsub_U") {
        ACMP_fsub_U.clk(clk);
