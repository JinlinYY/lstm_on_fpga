...
// ==============================================================
#ifndef __LSTM_Top_fdiv_32nbkb__HH__
#define __LSTM_Top_fdiv_32nbkb__HH__
#include "ACMP_fdiv.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(LSTM_Top_fdiv_32nbkb) {
    ...
    SC_CTOR(LSTM_Top_fdiv_32nbkb):  ACMP_fdiv_U ("ACMP_fdiv_U") {
        ACMP_fdiv_U.clk(clk);
